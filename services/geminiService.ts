...
// --- Helper functions to generate prompts and define response schemas ---
...
/**
 * This function calls the Gemini API directly from the client.
 * This is suitable for the AI Studio environment where the API key is provided securely.
 */
export const generateSectionContent = async (
  ...
  if (!apiKey) {
    throw new Error("API_KEY is not configured in this environment.");
  }
  ...
  try {
    ...
    if (responseSchema) {
        ...
        // Add unique IDs to list items so React can track them
        ...
        // Handle plain text response for 'about' section
        result = { body: text };
    }
